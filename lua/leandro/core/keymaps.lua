...
keymap.set("n", "<leader>nh", ":nohl<CR>") -- limpa o highlight depois de fazer uma busca
...
keymap.set("n", "<C-w>", ":bd<CR>") -- Salva o arquivo
...
keymap.set("n", "<leader>fg", "<cmd>Telescope lsp_document_symbols<cr>") -- list available help tags
